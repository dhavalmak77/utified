...
export default function XmlToHtml() {
	...
	const handleConversion = async () => {
		const html = await convertXMLToHTML(inputValue);
		setOutputValue(html);

		addToHistory(inputValue, html);
	};
	...
	return (
		<PageWrapper
			...
			description='Easily convert your XML data with HTML.'
			aside={true}
		>
			<ToolBoxWrapper>
				{/* First column */}
