...
export default function Base64() {
	...
	// Function to handle different JSON formats
	const handleConversion = () => {
		setError('');
		try {
			// Parse JSON input
			const jsonData = JSON.parse(encodeInput);
			
			// Check the type of JSON data and convert accordingly
			let dataToConvert = [];
	...
	return (
		<PageWrapper
			...
			description='Convert JSON data to CSV easily.'
			aside={true}
		>
			{/* Common Card */}
