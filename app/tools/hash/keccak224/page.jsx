...
const INPUT = 'Input';
const HASH = 'Keccak224';

const maxQrCodeLength = 2953;

export default function Keccak224() {
	...
	const generateHash = (data) => {
		try {
			const resultHash = jsSha3.keccak224(data);
			setHash(resultHash);
			setError('');
	...
	return (
		<PageWrapper
			title='Keccak224 Hash Generator'
			description='Generate Keccak224 hash.'
			aside={true}
		>
			{/* Common Card */}
