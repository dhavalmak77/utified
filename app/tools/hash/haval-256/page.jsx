...
export default function Haval256Page() {
	...
	const generateHash = (data) => {
		...
		timeoutId = setTimeout(async () => {
			try {
				const resultHash = await generatePhpHash(`haval256,${round}`, data);
	...
	return (
		<PageWrapper
			title='Haval256 Hash Generator'
			description='Generate Haval256 hash.'
			aside={true}
		>
			{/* Common Card */}
