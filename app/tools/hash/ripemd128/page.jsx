...
export default function RIPEMD128() {
	...
	const generateHash = (data) => {
		...
		try {
			let resultHash = calculateRipemdHash(data, 128);
	...
	return (
		<PageWrapper
			title='RIPEMD128 Hash Generator'
			description='Generate RIPEMD128 hash.'
			aside={true}
		>
			<ToolBoxWrapper>
				{/* First column */}
