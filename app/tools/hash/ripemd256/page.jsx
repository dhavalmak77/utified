...
export default function RIPEMD256() {
	...
	const generateHash = (data) => {
		...
		try {
			let resultHash = calculateRipemdHash(data, 256);
	...
	return (
		<PageWrapper
			title='RIPEMD256 Hash Generator'
			description='Generate RIPEMD256 hash.'
			aside={true}
		>
			<ToolBoxWrapper>
				{/* First column */}
