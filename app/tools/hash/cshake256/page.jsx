...
const INPUT = 'Input';
const HASH = 'cKeccak256';

const maxQrCodeLength = 2953;

export default function cKeccak256() {
	...
	const generateHash = (data) => {
		try {
			const resultHash = jsSha3.cshake256(data, 512, '', '');
			setHash(resultHash);
			setError('');
	...
	return (
		<PageWrapper
			title='cKeccak256 Hash Generator'
			description='Generate cKeccak256 hash.'
			aside={true}
		>
			{/* Common Card */}
