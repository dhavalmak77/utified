...
export default function Haval128Page() {
	...
	const generateHash = (data) => {
		...
		timeoutId = setTimeout(async () => {
			try {
				const resultHash = await generatePhpHash(`haval128,${round}`, data);
	...
	return (
		<PageWrapper
			title='Haval128 Hash Generator'
			description='Generate Haval128 hash.'
			aside={true}
		>
			{/* Common Card */}
