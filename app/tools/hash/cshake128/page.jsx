...
const INPUT = 'Input';
const HASH = 'cSHAKE128';

const maxQrCodeLength = 2953;

export default function cShake128() {
	...
	const generateHash = (data) => {
		try {
			const resultHash = jsSha3.cshake128(data, 256, '', '');
			setHash(resultHash);
			setError('');
	...
	return (
		<PageWrapper
			title='cShake128 Hash Generator'
			description='Generate cShake128 hash.'
			aside={true}
		>
			{/* Common Card */}
