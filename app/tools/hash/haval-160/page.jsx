...
export default function Haval160Page() {
	...
	const generateHash = (data) => {
		...
		timeoutId = setTimeout(async () => {
			try {
				const resultHash = await generatePhpHash(`haval160,${round}`, data);
	...
	return (
		<PageWrapper
			title='Haval160 Hash Generator'
			description='Generate Haval160 hash.'
			aside={true}
		>
			{/* Common Card */}
