...
export default function Tiger160Page() {
	...
	const generateHash = (data) => {
		...
		timeoutId = setTimeout(async () => {
			try {
				const resultHash = await generatePhpHash(`tiger160,${round}`, data);
	...
	return (
		<PageWrapper
			title='Tiger160 Hash Generator'
			description='Generate Tiger160 hash.'
			aside={true}
		>
			{/* Common Card */}
