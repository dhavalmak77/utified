...
export default function Tiger128Page() {
	...
	const generateHash = (data) => {
		...
		timeoutId = setTimeout(async () => {
			try {
				const resultHash = await generatePhpHash(`tiger128,${round}`, data);
	...
	return (
		<PageWrapper
			title='Tiger128 Hash Generator'
			description='Generate Tiger128 hash.'
			aside={true}
		>
			{/* Common Card */}
