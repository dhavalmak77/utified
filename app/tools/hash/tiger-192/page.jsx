...
export default function Tiger192Page() {
	...
	const generateHash = (data) => {
		...
		timeoutId = setTimeout(async () => {
			try {
				const resultHash = await generatePhpHash(`tiger192,${round}`, data);
	...
	return (
		<PageWrapper
			title='Tiger192 Hash Generator'
			description='Generate Tiger192 hash.'
			aside={true}
		>
			{/* Common Card */}
					...
					>
						...
						>
							<Select
								...
								allowDeselect={false}
								searchable
								leftSection={<Text px={10} c='black'>Round</Text>}
								leftSectionWidth={64}
								w={108}
							/>
						</Group>
