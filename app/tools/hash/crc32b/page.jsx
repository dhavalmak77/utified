...
const currentTool = 'crc32b';
const rows = 5;

export default function CRC32b() {
	...
	const generateHash = (data) => {
		...
		debounce(
			...
			async () => {
				try {
					const resultHash = await generatePhpHash(`crc32b`, data);
	...
	return (
		<PageWrapper
			title='CRC32b Hash Generator'
			description='Generate CRC32b hash.'
			aside={true}
		>
			<ToolBoxWrapper>
				{/* First column */}
