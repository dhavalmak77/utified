...
export default function RIPEMD320() {
	...
	const generateHash = (data) => {
		...
		try {
			let resultHash = calculateRipemdHash(data, 320);
	...
	return (
		<PageWrapper
			title='RIPEMD320 Hash Generator'
			description='Generate RIPEMD320 hash.'
			aside={true}
		>
			<ToolBoxWrapper>
				{/* First column */}
