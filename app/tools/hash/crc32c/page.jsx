...
const currentTool = 'crc32c';
const rows = 5;

export default function CRC32c() {
	...
	const generateHash = (data) => {
		...
		debounce(
			...
			async () => {
				try {
					const resultHash = await generatePhpHash(`crc32c`, data);
	...
	return (
		<PageWrapper
			title='CRC32c Hash Generator'
			description='Generate CRC32c hash.'
			aside={true}
		>
			<ToolBoxWrapper>
				{/* First column */}
