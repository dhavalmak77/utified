...
export default function Haval224Page() {
	...
	const generateHash = (data) => {
		...
		timeoutId = setTimeout(async () => {
			try {
				const resultHash = await generatePhpHash(`haval224,${round}`, data);
	...
	return (
		<PageWrapper
			title='Haval224 Hash Generator'
			description='Generate Haval224 hash.'
			aside={true}
		>
			{/* Common Card */}
