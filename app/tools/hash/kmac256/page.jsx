...
const currentTool = 'kmac256';
const rows = 5;

export default function Kmac256() {
	...
	const generateHash = (data) => {
		...
		try {
			let resultHash = jsSha3.kmac256(data, '', 512, '');
	...
	return (
		<PageWrapper
			title='Kmac256 Hash Generator'
			description='Generate Kmac256 hash.'
			aside={true}
		>
			<ToolBoxWrapper>
				{/* First column */}
