...
export default function Haval192Page() {
	...
	const generateHash = (data) => {
		...
		timeoutId = setTimeout(async () => {
			try {
				const resultHash = await generatePhpHash(`haval192,${round}`, data);
	...
	return (
		<PageWrapper
			title='Haval192 Hash Generator'
			description='Generate Haval192 hash.'
			aside={true}
		>
			{/* Common Card */}
